          ...
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                ...
                <p class="mb-4">
                  Kamu Punya <span class="fw-bold">0</span> Promo Yang Sedang Berlangsung. <br>
                </p>
                <a href="javascript:;" class="btn btn-sm btn-outline-primary">Lihat Disini</a>
              </div>
            </div>
          ...
          <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <h3 class="card-title text-nowrap mb-1">Pcs</h3>
              </div>
            </div>
          </div>
        </div>
